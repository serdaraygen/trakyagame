...
client.ayarlar = {
	...
	prefix: "$", // Ön-ek
	token: "NTM2MDkyMjE4NTk5OTMxOTE1.DyRv8g.sUy6v6KXtI2f5sTb8A3VgAcXLcE",
  ...
  oyun: "{prefix}yardım | {sunucu} sunucu | {kullanıcı} kullanıcı {site} ", // Oynuyor yeri, Burayı dilediğiniz şekilde değiştirebilirsiniz.
	oyundurum: "('${prefix}') yardım | ", // Oynuyor durumu sadece oynuyor veya dinliyor veya izliyor yazabilirsiniz eğer bunlar dışında bir şey yazarsanız veya boş bırakırsanız direk oynuyor gözükecektir.
